...
import 'package:note_app/View/archContent.dart';
import 'package:note_app/View/editContent.dart';
import 'package:note_app/View/favContent.dart';
import 'package:note_app/View/signIn.dart';

// ignore: must_be_immutable
class NotesList extends StatefulWidget {
  User connectedUser;
  NotesList({super.key, required this.connectedUser});
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const ArchNote(),
                  ),
                );
              },
            ),
